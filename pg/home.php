    ...
    <div class="box">
      ...
      <article class="post">
        ...
        <div class="post-body">
          ...
          <div class="post-info"> <span>Posted by: admin</span> <a href="single.html" class="btn btn-inverse">View More</a> </div>
        </div>
      </article>
      <!-- POST - END -->
      <!-- POST - START -->
      ...
      <article class="post gallery-post">
        <div class="post-date-wrapper">
          ...
          <div class="post-type"> <i class="fa fa-soundcloud"></i> </div>
        </div>
        <div class="post-body">
      ...
      <article class="post">
        <div class="post-date-wrapper">
          ...
          <div class="post-type"> <i class="fa fa-photo"></i> </div>
        </div>
        <div class="post-body">
          <h2>Blog post with Soundcloud</h2>
          <div class="flex-video soundcloud"> https://soundcloud.com/detonafunkoficial/mcs-zaac-e-jerry-bumbum-granada-dj-kelvinho-e-dj-redx-menininho-lancamento-2016
            <iframe width="166" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/242942763&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>
          </div>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam auctor dictum nibh, ac gravida orci porttitor et. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nullam posuere magna a dapibus luctus. Curabitur posuere vel nisi et scelerisque. Praesent imperdiet sed enim et ornare. In congue quis enim ut gravida. Aenean non justo varius, dapibus ipsum eu, mattis urna.</p>
          <div class="post-info"> <span>Posted by: admin</span> <a href="single.html" class="btn btn-inverse">View More</a> </div>
        </div>
      ...
      <article class="post">
        ...
        <div class="post-body">
          <h2>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam auctor dictum nibh, ac gravida orci porttitor et.</h2>
          <div class="flex-video widescreen">
            <iframe width="1280" height="720" src="https://www.youtube.com/embed/ZgYWkbMRhz8?rel=0" allowfullscreen></iframe>
          </div>
